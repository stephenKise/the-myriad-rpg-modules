...
function clanbuffs_getmoduleinfo(){
        $info = array(
				...
				"eroundinc"=>"Rounds (increment), range,0,50,1|10",
                        "Max Levels,title",
				"maxatk"=>"Maximum Attack Level, range,0,50,1|10",
				"maxdef"=>"Maximum Defense Level, range,0,50,1|10",
				"maxdrain"=>"Maximum Drain HP Level, range,0,50,1|10",
				"maxthorn"=>"Maximum Thorn Level, range,0,50,1|10",
				"maxregen"=>"Maximum Regen Level, range,0,50,1|10",
				"maxround"=>"Maximum Round Level, range,0,50,1|15",
                ),
                "prefs"=>array(
