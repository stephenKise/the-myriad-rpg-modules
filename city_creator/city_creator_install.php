<?php
	...
	else
	{
		...
		{
			db_query("INSERT INTO " . db_prefix('cities') . " (`cityname`,`citytype`,`cityauthor`,`cityactive`,`cityblocknavs`,`module`) VALUES ('".getsetting('villagename', LOCATION_FIELDS)."','Village','Eric Stevens',1,'".mysql_real_escape_string(serialize(array('forest'=>1,'weapons'=>1,'armor'=>1)))."','city_creator')");
