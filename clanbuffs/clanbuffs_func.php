...
function apply_clan_buff_for_one() {
	...
	apply_buff("clanbuff",array(
		"name"=>"`^Brotherly Bulwark`0",
		"atkmod"=>$atkmod,
		"defmod"=>$defmod,
		"lifetap"=>$lifetap,
		"effectmsg"=>sprintf_translate("`6Your Guild Aura allows you to absorb `^{damage}`6 of the damage you dealt to {badguy}!"),
		"allowinpvp"=>$allowinpvp,
		"allowintrain"=>$allowintrain,
		"rounds"=>$rounds,
		"roundmsg"=>"Your Guild's Aura strengthens you!",
	...
	apply_buff("clanbuff2",array(
		...
		"effectmsg"=>sprintf_translate("`6Your Guild Aura allows you to reflect `^{damage}`6 of the damage you received {badguy}!"),
		"allowinpvp"=>$allowinpvp,
		"allowintrain"=>$allowintrain,
		"rounds"=>$rounds,
		"schema"=>"module-clanbuffs",
	...
	apply_buff("clanbuff3",array(
		"name"=>"`^Salubrious Salve`0",
		"regen"=>$regen."*<level>",
		"effectmsg"=>sprintf_translate("`6Your Guild Aura allows you to regenerate `^{damage}`6 damage!"),
		"allowinpvp"=>$allowinpvp,
		"allowintrain"=>$allowintrain,
		"rounds"=>$rounds,
		"schema"=>"module-clanbuffs",
